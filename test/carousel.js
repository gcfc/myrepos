var carousel = (function() {
    ...
    function setupDraggable() {
        ...
        Draggable.create($carouselItems, {
            ...
            onDragEnd: function() {
                ...
                if (swipeDir == 'left') { activeID++ } else if (swipeDir == 'right') { activeID-- };
    ...
    function slideDone() {
        ...
        //
        if (activeID == 0) { $arrowPrev.fadeOut() } else { $arrowPrev.fadeIn() }

        if (activeID + 1 == carousel_count) { $arrowNext.fadeOut() } else { $arrowNext.fadeIn() }
    }
    ...
    $itemArrow.on('click', function() {
        ...
        if ($(this).hasClass('item_next')) { activeID++ } else { activeID-- };
